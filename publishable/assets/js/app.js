...
/***/ "./resources/assets/js/adv_image.js":
/*!******************************************!*\
  !*** ./resources/assets/js/adv_image.js ***!
  \******************************************/
/***/ (() => {
...
/***/ "./resources/assets/js/adv_inline.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/adv_inline.js ***!
  \*******************************************/
/***/ (() => {
...
/***/ "./resources/assets/js/adv_json.js":
/*!*****************************************!*\
  !*** ./resources/assets/js/adv_json.js ***!
  \*****************************************/
/***/ (() => {
...
$('document').ready(function () {
  ...
  vext_page_content.on('click', '.add-json', function () {
    var json_list = $(".adv-json-list.".concat($(this).data('field')));
  ...
  vext_page_content.on('click', '.remove-json', function () {
    ...
    var elList = $("#adv-json-list-".concat($(this).data('field')));
  ...
  vext_page_content.on('change', '.adv-json-item input', function () {
    var elList = $("#adv-json-list-".concat($(this).data('masterField')));
    collectFieldsAndMakeJSON(elList);
  }); // ------------------------------
  // Make JSON data
  // ------------------------------
  ...
  function collectFieldsAndMakeJSON(elList) {
    ...
    elList.find('.adv-json-item').each(function (iRow, elRow) {
      ...
      $(elRow).find('input').each(function (iInput, elInput) {
        var input = $(elInput); // Generate header fields
...
/***/ "./resources/assets/js/adv_media_files.js":
/*!************************************************!*\
  !*** ./resources/assets/js/adv_media_files.js ***!
  \************************************************/
/***/ (() => {
        ...
        callback: function callback() {
          ...
          $.ajax({
            ...
            success: function success(response) {
              if (response && response.data && response.data.status && response.data.status == 200) {
                toastr.success(response.data.message); // Update File and Filename
...
/***/ "./resources/assets/js/adv_page_layout.js":
/*!************************************************!*\
  !*** ./resources/assets/js/adv_page_layout.js ***!
  \************************************************/
/***/ (() => {
...
// Vendor JS code
__webpack_require__(/*! zebra_dialog */ "./node_modules/zebra_dialog/dist/zebra_dialog.min.js");
...
__webpack_require__(/*! ./adv_inline.js */ "./resources/assets/js/adv_inline.js");
...
var getDialogPosition = function getDialogPosition(evt, extra) {
  var offs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
$('document').ready(function () {
  ...
  window.vext_page_content = $(".page-content"); // Bread field helper binding
...
/***/ "./resources/assets/js/voyager_legacy.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/voyager_legacy.js ***!
  \***********************************************/
/***/ (() => {
...
/***/ "./node_modules/zebra_dialog/dist/zebra_dialog.min.js":
/*!************************************************************!*\
  !*** ./node_modules/zebra_dialog/dist/zebra_dialog.min.js ***!
  \************************************************************/
/***/ (() => {
...
/******/ 		var installedChunks = {
/******/ 			"/publishable/assets/js/app": 0,
/******/ 			"publishable/assets/css/app": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["publishable/assets/css/app"], () => (__webpack_require__("./resources/assets/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["publishable/assets/css/app"], () => (__webpack_require__("./resources/assets/less/app.less")))
