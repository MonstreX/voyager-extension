            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body" style="padding:30px;">
                        <div class="dd">
                            {!! menu($menu->name, 'voyager-extension::menu.admin', ['isModelTranslatable' => $isModelTranslatable]) !!}
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function () {
            ...
            $(".tiny-toggle").tinyToggle({
                onChange: function() {
                    ...
                    $.post('{{ route('voyager.menu-items.ext-record-update', '__id') }}'.replace('__id', $(this).data('id')), params, function (response) {
                        if (response
                            && response.data
